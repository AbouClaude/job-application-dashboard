...
from Utils.Functions import Draw_bar, Draw_boxplot, Draw_pie, Draw_upset_png
from Utils.streamlit_ui import render_document_upset, render_reply_metrics
...
def main():
    ...
    with col3:
        ...
        render_document_upset(parse_document_columns(df))
